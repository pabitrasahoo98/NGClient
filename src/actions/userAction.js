...
export const login =(email,password) =>
  async (dispatch) => {
    try {
      ...
      let link = `https://ng-server.vercel.app/api/v1/login`;
...
async (dispatch) => {
  try {
    ...
    const config={headers:{"Content-Type":"application/json"},withCredentials:true}
    let link = `https://ng-server.vercel.app/api/v1/register`;
...
export const loadUser =() =>
  async (dispatch) => {
    try {
      ...
      let link = `https://ng-server.vercel.app/api/v1/me`;
...
async (dispatch) => {
  try {
    ...
    const config={headers:{"Content-Type":"application/json"},withCredentials:true}
    let link = `https://ng-server.vercel.app/api/v1/password/update`;
...
async (dispatch) => {
  try {
    ...
    const config={headers:{"Content-Type":"application/json"},withCredentials:true}
    let link = `https://ng-server.vercel.app/api/v1/me/update`;
...
export const forgotPassword =(email) =>
  async (dispatch) => {
    try {
      ...
      const config={headers:{"Content-Type":"application/json"},withCredentials:true}
      let link = `https://ng-server.vercel.app/api/v1/password/forgot`;
...
export const resetPassword =(otp,newPassword) =>
  async (dispatch) => {
    try {
      ...
      const config={headers:{"Content-Type":"application/json"},withCredentials:true}
      let link = `https://ng-server.vercel.app/api/v1/password/reset`;
...
async (dispatch) => {
 ...
 async (dispatch) => {
   try {
     ...
     let link = `https://ng-server.vercel.app/api/v1/admin/users`;
...
dispatch( CLEAR_AUERRORS());
 ...
 export const deleteUser=(id)=>async(dispatch)=>{
   ...
   try {
       ...
       const config={headers:{"Content-Type":"application/json"},withCredentials:true}
       const {data}=await axios.delete(`https://ng-server.vercel.app/api/v1/admin/user/${id}`,config);
  ...
  export const updateUser=(id,orderData)=>async(dispatch)=>{
   ...
   try {
       ...
       const config={headers:{"Content-Type":"application/json"},withCredentials:true}
       const {data}=await axios.put(`https://ng-server.vercel.app/api/v1/admin/user/${id}`,orderData,config);
  ...
  async (dispatch) => {
    try {
      ...
      let link = `https://ng-server.vercel.app/api/v1/admin/user/${id}`;
