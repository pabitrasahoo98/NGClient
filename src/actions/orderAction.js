...
export const createOrder=(order)=>async(dispatch)=>{
    ...
    try {
        ...
        const {data}=await axios.post(`https://ng-server.vercel.app/api/v1/order/new`,order,config);
...
export const myOrder=()=>async(dispatch)=>{
  ...
  try {
      ...
      const {data}=await axios.get(`https://ng-server.vercel.app/api/v1/orders/me`,{withCredentials:true});
...
export const getOrderDetails=(id)=>async(dispatch)=>{
  ...
  try {
      ...
      const {data}=await axios.get(`https://ng-server.vercel.app/api/v1/order/${id}`,{withCredentials:true});
...
dispatch( CLEAR_ODERRORS());
 ...
 async (dispatch) => {
   try {
     ...
     let link = `https://ng-server.vercel.app/api/v1/admin/orders`;
...
dispatch( CLEAR_AOERRORS());
 ...
 export const deleteOrder=(id)=>async(dispatch)=>{
   ...
   try {
       ...
       const config={headers:{"Content-Type":"application/json"},withCredentials:true}
       const {data}=await axios.delete(`https://ng-server.vercel.app/api/v1/admin/order/${id}`,config);
  ...
  export const updateOrder=(id,orderData)=>async(dispatch)=>{
   ...
   try {
       ...
       const {data}=await axios.put(`https://ng-server.vercel.app/api/v1/admin/order/${id}`,orderData,config);
 ...
 export const cancelOrder=(id)=>async(dispatch)=>{
  ...
  try {
      ...
      const config={headers:{"Content-Type":"application/json"},withCredentials:true}
      const {data}=await axios.delete(`https://ng-server.vercel.app/api/v1/cancelorder/${id}`,config);
