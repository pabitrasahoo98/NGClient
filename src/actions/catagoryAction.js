...
//ADMIN-- CLEAR CAROUSEL DETAILS ERROR
 ...
 dispatch( CLEAR_UCARERRORS());
     ...
     async (dispatch) => {
       try {
         ...
         let link = `https://ng-server.vercel.app/api/v1/admin/subcatagories`;
    ...
    dispatch( CLEAR_SCERRORS());
       ...
       async (dispatch) => {
         try {
           ...
           let link = `https://ng-server.vercel.app/api/v1/admin/brand`;
 ...
 async (dispatch) => {
   try {
     ...
     let link = `https://ng-server.vercel.app/api/v1/admin/manipulatesubcatagory`;
 ...
 async (dispatch) => {
   try {
     ...
     let link = `https://ng-server.vercel.app/api/v1/admin/manipulatebrand`;
 ...
 async (dispatch) => {
   try {
     ...
     let link = `https://ng-server.vercel.app/api/v1/admin/manipulatesubcatagory/${id}`;
 ...
 async (dispatch) => {
   try {
     ...
     let link = `https://ng-server.vercel.app/api/v1/admin/manipulatebrand/${id}`;
...
export const fetchSubcatagory = (id) => async (dispatch) => {
  try {
    const link = `https://ng-server.vercel.app/api/v1/catagorysubcatagory/${id}`;
    const { data } = await axios.get(link);
...
export const fetchBrand = (id) => async (dispatch) => {
  try {
    const link = `https://ng-server.vercel.app/api/v1/catagorybrand/${id}`;
    const { data } = await axios.get(link);
