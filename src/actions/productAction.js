...
async (dispatch) => {
  try {
    ...
    let link = `https://ng-server.vercel.app/api/v1/product/${id}`;
...
//get similar products
  ...
  async (dispatch) => {
    try {
      ...
      let link = `https://ng-server.vercel.app/api/v1/admin/products`;
...
export const createProduct=(productData)=>async(dispatch)=>{
  ...
  try {
      ...
      const {data}=await axios.post(`https://ng-server.vercel.app/api/v1/admin/product/new`,productData,config);
...
dispatch( CLEAR_NPERRORS());
  ...
  export const deleteProduct=(id)=>async(dispatch)=>{
    ...
    try {
        ...
        const config={headers:{"Content-Type":"application/json"},withCredentials:true}
        const {data}=await axios.delete(`https://ng-server.vercel.app/api/v1/admin/product/${id}`,config);
   ...
   export const updateProduct=(id,productData)=>async(dispatch)=>{
    ...
    try {
        ...
        const config={headers:{"Content-Type":"application/json"},withCredentials:true}
        const {data}=await axios.put(`https://ng-server.vercel.app/api/v1/admin/product/${id}`,productData,config);
